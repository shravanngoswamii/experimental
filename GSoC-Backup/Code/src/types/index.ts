...
export interface GraphNode {
  ...
  initialValue?: unknown; // Initial value for MCMC chains, type is unknown
...
declare module 'cytoscape' {
  interface NodeSingular {
    ...
    data(key: 'initialValue'): unknown | undefined;
    ...
    data(key: string, value: unknown): NodeSingular;
