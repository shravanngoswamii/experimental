...
This example can be run wherever you have Julia installed (see [Getting Started]({{< var site-url >}}docs/using-turing/getting-started/), but you will need to install the packages `Turing` and `StatsPlots` if you have not done so already.

This is an excerpt from a more formal example which can be found in the documentation website [here]({{< var site-url >}}docs/tutorials/introduction/).
